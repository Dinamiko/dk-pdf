	...
	public function display_field ( $data = array(), $post = false, $echo = true ) {
		...
		switch( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'dk-pdf' ) . '" data-uploader_button_text="' . __( 'Use image' , 'dk-pdf' ) . '" class="image_upload_button button" value="'. __( 'Upload new image' , 'dk-pdf' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="'. __( 'Remove image' , 'dk-pdf' ) . '" />' . "\n";
