...
namespace Dinamiko\DKPDF\Vendor\Mpdf\PsrHttpMessageShim;

use Dinamiko\DKPDF\Vendor\Psr\Http\Message\StreamInterface;
use Dinamiko\DKPDF\Vendor\Psr\Http\Message\ResponseInterface;
use Dinamiko\DKPDF\Vendor\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \Dinamiko\DKPDF\Vendor\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \Dinamiko\DKPDF\Vendor\Psr\Http\Message\StreamInterface */
	private $stream;
