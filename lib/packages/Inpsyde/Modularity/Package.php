...
namespace Dinamiko\DKPDF\Vendor\Inpsyde\Modularity;

use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Container\ContainerConfigurator;
use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Container\PackageProxyContainer;
use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Module\ExecutableModule;
use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Module\ExtendingModule;
use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Module\FactoryModule;
use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Module\Module;
use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Module\ServiceModule;
use Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Properties\Properties;
use Dinamiko\DKPDF\Vendor\Psr\Container\ContainerInterface;

/**
 * @phpstan-import-type Service from \Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Module\ServiceModule
 * @phpstan-import-type ExtendingService from \Dinamiko\DKPDF\Vendor\Inpsyde\Modularity\Module\ExtendingModule
 */
class Package
{
    /**
